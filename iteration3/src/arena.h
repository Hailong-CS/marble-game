...
class Arena {
  ...
  */
  ...
  std::vector<class Autobot*> autobots(void) {
    return autobot_;
  }
 ...
 private:
  ...
  void CheckForConeView(const class ArenaEntity * const ent,
  ...
  std::vector<class Autobot*> autobot_;
};
